        ...
        >
          ...
          <div className="relative my-7 auth-stagger-3">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span
                className="px-4 text-[#A0B0C8]/60 text-[10px] font-semibold tracking-[0.15em]"
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-2 auth-stagger-5">
              <Label htmlFor="password" className="text-[11px] font-semibold text-[#A0B0C8] uppercase tracking-[0.15em]">
                Contrasena
              </Label>
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 rounded-xl auth-input pr-11 text-white placeholder:text-[#8899B4]/45 text-[14px]"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[#8899B4]/60 hover:text-white transition-colors duration-200"
                >
