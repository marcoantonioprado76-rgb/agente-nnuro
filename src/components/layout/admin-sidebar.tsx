    ...
    >
      ...
      <div className="sidebar-brand-header">
        <div className="flex items-center gap-3.5">
          ...
          <Link href="/admin/dashboard" className="relative shrink-0">
            <Bell className="h-5 w-5 text-[#64748B]/60 hover:text-white transition-colors duration-200" />
            ...
            {[
              ...
              >
                <div className="flex items-center justify-center gap-1 mb-1">
                  ...
                  <span className="text-[9px] font-medium text-[#64748B]/70">{stat.label}</span>
                </div>
      ...
      <nav className="flex-1 flex flex-col overflow-y-auto px-3 py-4 space-y-0.5">
        <div className="mb-3 px-3">
          <span className="text-[9px] font-semibold uppercase tracking-[0.15em] text-[#64748B]/50">
            Navegación
          </span>
        </div>
            ...
            >
              ...
              <item.icon
                className={cn(
                  ...
                  isActive ? 'text-[#8B5CF6]' : 'text-[#64748B]/50 group-hover:text-[#CBD5E1]'
                )}
              />
              <div className="flex flex-col min-w-0 flex-1">
                ...
                <span
                  className={cn(
                    ...
                    isActive ? 'text-[#8B5CF6]/50' : 'text-[#64748B]/30 group-hover:text-[#64748B]/50'
                  )}
                >
                  {item.description}
                </span>
      ...
      <div className="px-3 py-3">
        <Link
          href="/dashboard"
          className="flex items-center gap-2 rounded-xl px-3 py-2 text-xs font-medium text-[#64748B]/60 transition-all duration-200 sidebar-item-hover hover:text-[#CBD5E1]"
        >
      ...
      <div className="p-3">
        ...
        >
          ...
          <div className="flex flex-1 flex-col min-w-0">
            ...
            <span className="truncate text-[10px] text-[#64748B]/50">
              {profile?.email || ''}
            </span>
            <Badge
              variant="secondary"
          ...
          <Button
            variant="ghost"
            size="icon"
            className="h-8 w-8 shrink-0 text-[#64748B]/50 hover:text-red-400 hover:bg-red-500/8 transition-colors duration-200"
            onClick={signOut}
            title="Cerrar sesión"
          >
