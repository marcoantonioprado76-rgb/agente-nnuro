...
export default function StoresPage() {
  ...
  const openEdit = (store: StoreItem) => {
    ...
    setForm({
      ...
      cover_images: store.cover_images || [],
        ...
        <div className="flex-1 flex items-center justify-center py-20">
          <div className="flex flex-col items-center gap-3">
            <div className="relative">
              ...
              <Store className="absolute inset-0 m-auto h-5 w-5 text-[#06B6D4]" />
            </div>
    ...
    <>
      ...
      <div className="p-4 md:p-6 space-y-4 md:space-y-6">
        ...
        <div
          ...
          style={{ background: 'linear-gradient(135deg, rgba(17, 29, 53, 0.9), rgba(22, 32, 51, 0.7))', border: '1px solid rgba(6, 182, 212, 0.08)' }}
        >
          ...
          <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
            <div className="flex items-center gap-4">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl shrink-0" style={{ background: 'linear-gradient(135deg, #06B6D4, #8B5CF6)', boxShadow: '0 6px 24px rgba(6, 182, 212, 0.3)' }}>
                <Store className="h-7 w-7 text-white" />
              </div>
              <div>
                <h1 className="text-2xl font-bold text-white flex items-center gap-2">
                  Mis Tiendas Virtuales
                  <span className="text-[11px] font-semibold px-2.5 py-0.5 rounded-full" style={{ background: 'rgba(6, 182, 212, 0.12)', color: '#06B6D4', border: '1px solid rgba(6, 182, 212, 0.15)' }}>{stores.length}</span>
                </h1>
                <p className="text-sm text-[#94A3B8] mt-0.5">Tu galeria de escaparates digitales para vender en la web</p>
              </div>
            </div>
            <Button onClick={openCreate} className="h-11 px-6 text-sm font-semibold text-white rounded-xl shrink-0" style={{ background: 'linear-gradient(135deg, #06B6D4, #8B5CF6)', boxShadow: '0 4px 16px rgba(6, 182, 212, 0.3)' }}>
          ...
          <div className="relative grid grid-cols-2 sm:grid-cols-4 gap-3 mt-5">
            {[
              { label: 'Total Tiendas', value: stores.length, icon: Store, color: '#06B6D4' },
        ...
        {stores.length === 0 ? (
          <div className="relative overflow-hidden rounded-2xl p-14 text-center animate-fade-in-up-delay-1" style={{ background: 'linear-gradient(135deg, rgba(17, 29, 53, 0.8), rgba(22, 32, 51, 0.6))', border: '1px solid rgba(255, 255, 255, 0.06)' }}>
            <div className="absolute top-0 right-0 w-80 h-80 rounded-full blur-[100px] opacity-20 pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(6, 182, 212, 0.2), transparent)' }} />
            ...
            <div className="relative space-y-6">
              <div className="mx-auto w-28 h-28 relative">
                <div className="absolute inset-0 rounded-3xl" style={{ background: 'linear-gradient(135deg, rgba(6, 182, 212, 0.1), rgba(139, 92, 246, 0.06))', border: '1px solid rgba(6, 182, 212, 0.1)', boxShadow: '0 0 40px rgba(6, 182, 212, 0.08)' }} />
                <div className="absolute inset-0 flex items-center justify-center"><Store className="h-12 w-12 text-[#06B6D4]" /></div>
              ...
              <Button onClick={openCreate} className="h-12 px-8 text-sm font-semibold text-white rounded-xl" style={{ background: 'linear-gradient(135deg, #06B6D4, #8B5CF6)', boxShadow: '0 4px 20px rgba(6, 182, 212, 0.3)' }}>
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 animate-fade-in-up-delay-1">
            {stores.map((store) => {
              ...
              const bannerBg = storeBg
                ...
                : 'linear-gradient(160deg, rgba(6, 182, 212, 0.1) 0%, rgba(139, 92, 246, 0.06) 50%, rgba(22, 32, 51, 0.9) 100%)'
              return (
                <div key={store.id} className="group relative overflow-hidden rounded-2xl transition-all duration-300 glass-panel-hover" style={{ background: 'linear-gradient(180deg, rgba(17, 29, 53, 0.9) 0%, rgba(13, 21, 41, 0.95) 100%)', border: '1px solid rgba(255, 255, 255, 0.06)', boxShadow: '0 4px 24px rgba(0, 0, 0, 0.2)' }}>
                  <div className="relative h-44 overflow-hidden" style={{ background: bannerBg }}>
                    ...
                    <div className="absolute -bottom-12 -left-12 w-28 h-28 rounded-full blur-[50px] opacity-15 pointer-events-none" style={{ background: '#8B5CF6' }} />
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="relative">
                        ...
                        <div className="relative flex h-[96px] w-[96px] items-center justify-center rounded-3xl transition-transform duration-300 group-hover:scale-105" style={{ background: `linear-gradient(145deg, ${accentColor}18, ${accentColor}08)`, border: `1.5px solid ${accentColor}30`, boxShadow: `0 0 40px ${accentColor}18, inset 0 1px 0 rgba(255,255,255,0.06)`, backdropFilter: 'blur(12px)' }}>
                          <Store className="h-11 w-11 transition-all duration-300 group-hover:drop-shadow-[0_0_10px_rgba(6,182,212,0.4)]" style={{ color: accentColor }} />
                        </div>
                        ...
                        <div className="absolute -bottom-2 -left-4 flex h-7 w-7 items-center justify-center rounded-xl transition-transform duration-300 group-hover:translate-y-0.5" style={{ background: 'rgba(139, 92, 246, 0.12)', border: '1px solid rgba(139, 92, 246, 0.18)', backdropFilter: 'blur(8px)' }}><Package className="h-3 w-3 text-[#8B5CF6]" /></div>
                      </div>
                    </div>
                  ...
                  <div className="p-5 pt-4 space-y-3.5">
                    <div>
                      ...
                      <p className="text-[11px] text-[#06B6D4]/60 mt-0.5 flex items-center gap-1"><Globe className="h-3 w-3 shrink-0" /><span className="truncate">/tienda/{store.slug}</span></p>
                    </div>
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                      {[
                        { icon: Package, value: store.product_count, label: 'Productos', color: '#A78BFA' },
                        { icon: Eye, value: '-', label: 'Visitas', color: '#06B6D4' },
                    ...
                    <div className="flex gap-2 pt-2" style={{ borderTop: '1px solid rgba(255, 255, 255, 0.04)' }}>
                      <Button onClick={() => window.location.href = `/stores/${store.id}`} className="flex-1 h-10 text-[13px] font-semibold text-white rounded-xl gap-2" style={{ background: 'linear-gradient(135deg, rgba(6, 182, 212, 0.15), rgba(139, 92, 246, 0.1))', border: '1px solid rgba(6, 182, 212, 0.15)' }}><Package className="h-4 w-4" />Gestionar</Button>
                      ...
                      <button onClick={() => window.open(`${appUrl}/tienda/${store.slug}`, '_blank')} className="flex h-10 w-10 items-center justify-center rounded-xl transition-colors duration-200 hover:bg-white/5 shrink-0" style={{ border: '1px solid rgba(255, 255, 255, 0.06)' }} title="Vista previa"><ArrowUpRight className="h-4 w-4 text-[#06B6D4]" /></button>
                    </div>
                  </div>
                </div>
              )
            ...
            {/* ── Add New ── */}
            <button onClick={openCreate} className="group flex flex-col items-center justify-center rounded-2xl p-8 transition-all duration-300 cursor-pointer min-h-[440px]" style={{ background: 'rgba(255, 255, 255, 0.012)', border: '2px dashed rgba(6, 182, 212, 0.1)' }}
              onMouseEnter={(e) => { e.currentTarget.style.borderColor = 'rgba(6, 182, 212, 0.3)'; e.currentTarget.style.background = 'rgba(6, 182, 212, 0.025)' }}
              onMouseLeave={(e) => { e.currentTarget.style.borderColor = 'rgba(6, 182, 212, 0.1)'; e.currentTarget.style.background = 'rgba(255, 255, 255, 0.012)' }}
            >
              <div className="relative mb-5">
                <div className="absolute -inset-4 rounded-full opacity-20 blur-[16px] pointer-events-none" style={{ background: 'radial-gradient(circle, #06B6D4, transparent)' }} />
                <div className="relative flex h-16 w-16 items-center justify-center rounded-2xl transition-all duration-300 group-hover:scale-110" style={{ background: 'rgba(6, 182, 212, 0.08)', border: '1.5px solid rgba(6, 182, 212, 0.12)', boxShadow: '0 0 24px rgba(6, 182, 212, 0.06)' }}>
                  <Plus className="h-7 w-7 text-[#06B6D4]" />
                </div>
              </div>
              <p className="text-sm font-semibold text-[#06B6D4]">Nueva Tienda</p>
      ...
      <Dialog open={dialogOpen} onOpenChange={(open) => { setDialogOpen(open); if (!open) setFontDropdownOpen(false) }}>
        <DialogContent
          ...
          style={{ background: '#0D1526', border: '1px solid rgba(6, 182, 212, 0.08)', maxHeight: '85vh' }}
        >
          {/* ── HEADER ── */}
          <DialogHeader className="px-6 pt-5 pb-3 shrink-0">
            <DialogTitle className="text-white text-lg font-bold flex items-center gap-2.5">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg" style={{ background: 'linear-gradient(135deg, #06B6D4, #8B5CF6)' }}>
          ...
          <div className="overflow-y-auto flex-1 min-h-0 px-6 pb-4">
            ...
            <div className="sticky top-0 z-10 -mx-6 px-6 pb-4 pt-1" style={{ background: 'linear-gradient(to bottom, #0D1526 85%, transparent)' }}>
              ...
              >
                ...
                {/* Glow */}
                <div className="absolute -top-10 -right-10 w-40 h-40 rounded-full blur-[60px] opacity-20 pointer-events-none" style={{ background: '#06B6D4' }} />
            ...
            <div className="space-y-4 mb-6">
              <SectionLabel icon={Store} label="Datos principales" color="#06B6D4" />
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    style={{ background: 'rgba(255, 255, 255, 0.04)', border: '1px solid rgba(255, 255, 255, 0.08)' }}
                  />
                  {form.slug && <p className="text-[10px] text-[#06B6D4]/60 truncate">{appUrl}/tienda/{form.slug}</p>}
                </div>
              </div>
            ...
            <div className="space-y-4 mb-6">
              ...
              {/* Cover Images (2-3 fotos para carrusel) */}
              <div className="space-y-2">
                <Label className="text-[11px] text-[#94A3B8]/80 font-medium">Fotos de portada (2-3 fotos para carrusel)</Label>
                <div className="grid grid-cols-3 gap-2">
                  {[0, 1, 2].map((i) => {
                    const imgUrl = form.cover_images[i] || ''
                    return (
                      <div key={`cover-${i}`}>
                        {imgUrl ? (
                          <div className="relative rounded-xl overflow-hidden aspect-[3/1]" style={{ border: '1px solid rgba(255, 255, 255, 0.08)' }}>
                            <img src={imgUrl} alt={`Portada ${i + 1}`} className="w-full h-full object-cover" />
                            <button
                              type="button"
                              onClick={() => {
                                const updated = [...form.cover_images]
                                updated.splice(i, 1)
                                setForm(prev => ({ ...prev, cover_images: updated }))
                              }}
                          ...
                          <label className="flex flex-col items-center justify-center gap-1 py-4 rounded-xl cursor-pointer transition-colors hover:bg-white/[0.02] aspect-[3/1]" style={{ border: '2px dashed rgba(236, 72, 153, 0.2)' }}>
                            <Upload className="h-4 w-4 text-[#EC4899]/40" />
                            <span className="text-[9px] text-[#94A3B8]/40">Portada {i + 1}</span>
                            <input type="file" accept="image/*" className="hidden" onChange={async (e) => {
                              ...
                              if (res.ok) {
                                const updated = [...form.cover_images]
                                updated[i] = data.url
                                setForm(prev => ({ ...prev, cover_images: updated.filter(Boolean) }))
                  ...
                  <div className="flex flex-col gap-1">
                    {SPACING_OPTIONS.map((s) => (
                      <button key={s.value} type="button" onClick={() => updateFontConfig({ letterSpacing: s.value })}
                        className="rounded-lg px-2 py-1.5 text-[11px] font-medium transition-all duration-150 text-center"
                        style={{
                          background: fc.letterSpacing === s.value ? 'rgba(6, 182, 212, 0.12)' : 'rgba(255, 255, 255, 0.02)',
                          color: fc.letterSpacing === s.value ? '#06B6D4' : '#64748B',
                          border: `1px solid ${fc.letterSpacing === s.value ? 'rgba(6, 182, 212, 0.2)' : 'rgba(255, 255, 255, 0.04)'}`,
                          letterSpacing: s.css,
                        }}
                      >{s.label}</button>
                    ))}
            ...
            {/* ━━━ DIVIDER ━━━ */}
            <div className="h-px mb-6" style={{ background: 'linear-gradient(to right, transparent, rgba(6, 182, 212, 0.15), transparent)' }} />

            {/* ━━━ SECTION 3: FONDO ━━━ */}
            <div className="space-y-4 mb-2">
              <SectionLabel icon={Palette} label="Color de fondo" color="#06B6D4" />
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  <button key={opt.type} type="button" onClick={() => updateBgConfig({ type: opt.type })}
                    ...
                    style={{
                      background: bg.type === opt.type ? 'rgba(6, 182, 212, 0.1)' : 'rgba(255, 255, 255, 0.02)',
                      color: bg.type === opt.type ? '#06B6D4' : '#64748B',
                      border: `1px solid ${bg.type === opt.type ? 'rgba(6, 182, 212, 0.2)' : 'rgba(255, 255, 255, 0.06)'}`,
                    }}
              ...
              {bg.type === 'solid' && (
                <div className="space-y-2.5">
                  <div className="grid grid-cols-10 gap-1.5">
                    {COLOR_PRESETS.map((color) => (
                      <button key={color} type="button" onClick={() => updateBgConfig({ color })}
                        ...
                        style={{
                          background: color,
                          border: bg.color === color ? '2px solid #06B6D4' : '1px solid rgba(255, 255, 255, 0.1)',
                          boxShadow: bg.color === color ? '0 0 8px rgba(6, 182, 212, 0.3)' : 'none',
                        }}
                      >
                        {bg.color === color && <Check className="absolute inset-0 m-auto h-3 w-3 text-[#06B6D4]" />}
                      </button>
                    ))}
                  </div>
                  ...
                  >
                    ...
                    <span className="text-[#06B6D4] font-mono text-[10px]">{bg.color}</span>
                  </button>
                ...
                <div className="grid grid-cols-4 gap-2">
                  {GRADIENT_PRESETS.map((grad) => (
                    <button key={grad.label} type="button" onClick={() => updateBgConfig({ gradient: grad.value })}
                      ...
                      style={{
                        border: bg.gradient === grad.value ? '2px solid #06B6D4' : '1px solid rgba(255, 255, 255, 0.08)',
                        boxShadow: bg.gradient === grad.value ? '0 0 10px rgba(6, 182, 212, 0.25)' : 'none',
                      }}
                    >
                      ...
                      {bg.gradient === grad.value && <Check className="absolute top-1 right-1 h-3 w-3 text-[#06B6D4]" />}
                    </button>
                  ))}
                </div>
              )}
          ...
          >
            ...
            <Button
              onClick={handleSave}
              disabled={saving}
              className="group/btn text-white rounded-xl text-sm font-semibold h-10 px-6 transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_6px_28px_rgba(6,182,212,0.45)] active:scale-[0.97]"
