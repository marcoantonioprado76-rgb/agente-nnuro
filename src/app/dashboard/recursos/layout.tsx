  ...
  return (
    <div className="max-w-6xl mx-auto px-4 pt-6">
      <h1 className="text-2xl font-black text-[#111827] flex items-center gap-2">
        <i className="fa-solid fa-folder-open text-[#147e95]"></i> Recursos
      </h1>
        ...
        {TABS.map(t => {
          ...
          return (
            <Link key={t.href} href={t.href}
              ...
              style={active
                ? { background: 'linear-gradient(135deg, #1fb8bb 0%, #147e95 52%, #12303a 100%)', color: '#fff', boxShadow: '0 10px 24px -8px rgba(0,229,208,0.4)' }
