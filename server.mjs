...
╚══════════════════════════════════════════════════╝
  ...
  // Nota: el worker de rescate del buffer se arranca vía src/instrumentation.ts
  // (hook de Next), que corre en cualquier modo de arranque (next start /
  // server.mjs / standalone). Por eso aquí ya no se inicia nada.
