...
const STATEMENTS = [
  ...
  { label: 'voz: voice_enabled en bots', sql: `ALTER TABLE bots ADD COLUMN IF NOT EXISTS voice_enabled BOOLEAN NOT NULL DEFAULT false` },
  { label: 'voz: voice_id en bots', sql: `ALTER TABLE bots ADD COLUMN IF NOT EXISTS voice_id TEXT` },
  { label: 'voz: voice_mode en bots', sql: `ALTER TABLE bots ADD COLUMN IF NOT EXISTS voice_mode TEXT NOT NULL DEFAULT 'off'` },
