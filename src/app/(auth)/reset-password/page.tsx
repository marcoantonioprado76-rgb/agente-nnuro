        ...
        <div className="bg-[#1a1d27] border border-[#242736] rounded-2xl p-8 shadow-2xl">
          ...
          {done ? (
            <div className="text-center py-4">
              ...
              <p className="text-[#a0b0c8] text-sm">Redirigiendo al inicio de sesión...</p>
            </div>
          ) : (
            <>
              <h1 className="text-white text-2xl font-bold mb-2">Nueva contraseña</h1>
              <p className="text-[#a0b0c8] text-sm mb-6">Elige una contraseña segura para tu cuenta.</p>
              ...
              <form onSubmit={handleReset} className="space-y-4">
                <div className="space-y-2">
                  <Label className="text-[11px] font-semibold text-[#A0B0C8] uppercase tracking-[0.15em]">
                    Nueva contraseña
                  </Label>
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[#8899B4]/60 hover:text-white transition-colors"
                    >
