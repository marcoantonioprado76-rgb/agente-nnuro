              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-[#64748B]/60" />
                    <Input
                      id="email"
                      type="email"
                      ...
                      required
                      className="h-12 rounded-xl pl-10 bg-[#0F0F17] border-[#1A1A25] text-white placeholder:text-[#64748B]/45 text-[14px] focus:border-[#8B5CF6]"
                    />
                  </div>
                </div>
