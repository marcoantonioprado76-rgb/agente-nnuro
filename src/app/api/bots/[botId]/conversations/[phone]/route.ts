...
export async function GET(_req: NextRequest, { params }: Ctx) {
  try {
    ...
    return NextResponse.json({
      conversation: toClientConv(conv),
      messages: (messages ?? []).map(toClientMessage),
    })
  } catch (err) {
    console.error('[GET /api/bots/[botId]/conversations/[phone]]', err)
...
export async function DELETE(_req: NextRequest, { params }: Ctx) {
  try {
    ...
    console.error('[DELETE /api/bots/[botId]/conversations/[phone]]', err)
    return NextResponse.json({ error: 'Error interno' }, { status: 500 })
  }
}
...
export async function PATCH(req: NextRequest, { params }: Ctx) {
  try {
    ...
    if (body.markAsSold) {
      ...
      return NextResponse.json({ conversation: toClientConv(updated) })
    }
    ...
    console.error('[PATCH /api/bots/[botId]/conversations/[phone]]', err)
    return NextResponse.json({ error: 'Error interno' }, { status: 500 })
  }
}
...
export async function POST(req: NextRequest, { params }: Ctx) {
  try {
    ...
    return NextResponse.json({ message: toClientMessage(msg) })
  } catch (err) {
    console.error('[POST /api/bots/[botId]/conversations/[phone]]', err)
    return NextResponse.json({ error: 'Error interno' }, { status: 500 })
  }
}
