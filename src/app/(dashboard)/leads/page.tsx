...
const statusConfig: Record<string, { label: string; color: string; bg: string; border: string; icon: typeof CheckCircle2 }> = {
  ...
  interested: {
    label: 'Interesado',
    color: '#56CCF2',
    bg: 'rgba(86, 204, 242, 0.1)',
    border: 'rgba(86, 204, 242, 0.2)',
    icon: MessageSquare,
  },
  negotiating: {
    label: 'Negociando',
        ...
        <div className="flex-1 flex items-center justify-center py-20">
          <div className="flex flex-col items-center gap-3">
            <div className="relative">
              ...
              <Target className="absolute inset-0 m-auto h-5 w-5 text-[#56CCF2]" />
            </div>
      ...
      <div className="p-4 md:p-6 space-y-4 md:space-y-6">
        ...
        <div
          ...
          style={{
            ...
            border: '1px solid rgba(86, 204, 242, 0.08)',
          }}
        >
          ...
          <div className="relative flex items-center gap-4">
            <div
              ...
              style={{ background: 'linear-gradient(135deg, #56CCF2, #4F7CFF)', boxShadow: '0 6px 24px rgba(86, 204, 242, 0.3)' }}
            >
            ...
            <div>
              <h1 className="text-2xl font-bold text-white flex items-center gap-2">
                ...
                <span
                  ...
                  style={{ background: 'rgba(86, 204, 242, 0.12)', color: '#56CCF2', border: '1px solid rgba(86, 204, 242, 0.15)' }}
                >
                  {leads.length}
                </span>
              </h1>
        ...
        {leads.length === 0 ? (
          ...
          >
            <div
              ...
              style={{ background: 'rgba(86, 204, 242, 0.08)', border: '1px solid rgba(86, 204, 242, 0.1)' }}
            >
              <Target className="h-7 w-7 text-[#56CCF2]" />
            </div>
            ...
            <button
              ...
              style={{ background: 'linear-gradient(135deg, #56CCF2, #4F7CFF)', boxShadow: '0 4px 16px rgba(86, 204, 242, 0.25)' }}
            >
              ...
              {leads.map((lead) => {
                ...
                return (
                  <div key={lead.id} className="flex items-center gap-3 px-4 py-3.5">
                    ...
                    >
                      <UserCircle className="h-4 w-4 text-[#56CCF2]" />
                    </div>
