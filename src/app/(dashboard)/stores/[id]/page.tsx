          ...
          >
            ...
            <DialogFooter className="gap-2 sm:gap-2">
              <Button
                ...
                disabled={saving}
                className="text-[#CBD5E1] border-0 rounded-xl"
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center gap-2 pt-1">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 h-9 rounded-xl text-[12px] font-semibold text-[#CBD5E1] transition-all duration-200 hover:text-white hover:bg-white/[0.06]"
            style={{ border: '1px solid rgba(255, 255, 255, 0.06)' }}
          >
