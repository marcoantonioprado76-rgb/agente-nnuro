...
function SkeletonCard() {
  return (
    <div className="rounded-card p-6 animate-pulse"
      style={{ padding: 24,
        background: 'radial-gradient(120% 80% at 50% -10%, rgba(0,229,208,0.18), rgba(255,255,255,0) 58%), radial-gradient(90% 70% at 100% 110%, rgba(35,59,143,0.16), rgba(255,255,255,0) 60%), linear-gradient(180deg, #212e38 0%, #273842 60%, #1a262f 100%)',
