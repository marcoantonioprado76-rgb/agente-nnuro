...
const typeIcons: Record<string, { icon: typeof Bell; color: string; bg: string }> = {
  ...
  bot_creado: { icon: Bot, color: '#4F7CFF', bg: 'rgba(79, 124, 255, 0.1)' },
  ...
  tienda_actualizada: { icon: Store, color: '#56CCF2', bg: 'rgba(86, 204, 242, 0.1)' },
  ...
  lead_nuevo: { icon: Target, color: '#56CCF2', bg: 'rgba(86, 204, 242, 0.1)' },
  seguimiento_ejecutado: { icon: MessageSquare, color: '#F59E0B', bg: 'rgba(245, 158, 11, 0.1)' },
  cuenta_actualizada: { icon: Shield, color: '#4F7CFF', bg: 'rgba(79, 124, 255, 0.1)' },
  // Admin types
  usuario_registrado: { icon: UserPlus, color: '#4F7CFF', bg: 'rgba(79, 124, 255, 0.1)' },
      ...
      >
        ...
        {unreadCount > 0 && (
          <span
            ...
            style={{ background: '#4F7CFF', boxShadow: '0 0 8px rgba(79, 124, 255, 0.5)' }}
          >
            ...
            <div className="flex items-center gap-1">
              {unreadCount > 0 && (
                <button
                  ...
                  style={{ color: '#4F7CFF', background: 'rgba(79, 124, 255, 0.08)' }}
                >
          ...
          <div className="overflow-y-auto max-h-[420px] no-scrollbar">
            {notifications.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 px-6">
                ...
                >
                  <Bell className="h-5 w-5 text-[#4F7CFF]" />
                </div>
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        background: notification.is_read ? 'transparent' : 'rgba(79, 124, 255, 0.02)',
                      }}
                    >
                      {/* Icon */}
                      <div
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2">
                          <p className={`text-[12px] leading-tight ${notification.is_read ? 'text-[#CBD5E8]/80' : 'text-white font-medium'}`}>
                            {notification.title}
                          </p>
                      ...
                      {!notification.is_read && (
                        <div className="shrink-0 mt-1.5">
                          <div
                            ...
                            style={{ background: '#4F7CFF', boxShadow: '0 0 6px rgba(79, 124, 255, 0.5)' }}
                          />
                        </div>
                      )}
                    </button>
