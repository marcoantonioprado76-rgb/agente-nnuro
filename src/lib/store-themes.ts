...
export const STORE_THEMES: Record<string, Preset> = {
  'neon-dark': {
    ...
    vars: {
      ...
      '--st-card-border': 'rgba(0,229,208,0.20)',
  ...
  'royal': {
    ...
    vars: {
      ...
      '--st-card': 'linear-gradient(160deg, rgba(0,229,208,0.10), rgba(255,255,255,0.015))',
      '--st-card-border': 'rgba(0,229,208,0.26)',
