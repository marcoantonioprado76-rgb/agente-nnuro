        ...
        >
          ...
          <div className="relative my-7 auth-stagger-3">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="px-4 text-[#94A3B8]/60 text-[10px] font-semibold tracking-[0.15em]" style={{ background: 'linear-gradient(180deg, rgba(22, 38, 68, 0.72), rgba(16, 28, 52, 0.8))' }}>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="space-y-2 auth-stagger-4">
              <Label className="text-[11px] font-semibold text-[#94A3B8] uppercase tracking-[0.15em]">Correo electronico</Label>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <button type="button" onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-[#64748B]/60 hover:text-white transition-colors duration-200">
            ...
            <div className="space-y-2 auth-stagger-5">
              <Label className="text-[11px] font-semibold text-[#94A3B8] uppercase tracking-[0.15em]">Pais</Label>
            ...
            <div className="space-y-2 auth-stagger-5">
              <Label className="text-[11px] font-semibold text-[#94A3B8] uppercase tracking-[0.15em]">Numero de celular</Label>
